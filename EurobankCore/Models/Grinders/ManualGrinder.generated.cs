...
[assembly: RegisterDocumentType(ManualGrinder.CLASS_NAME, typeof(ManualGrinder))]

namespace CMS.DocumentEngine.Types.Eurobank
{
	/// <summary>
	/// Represents a content item of type ManualGrinder.
	/// </summary>
	public partial class ManualGrinder : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Eurobank.ManualGrinder";


		/// <summary>
		/// The instance of the class that provides extended API for working with ManualGrinder fields.
		/// </summary>
		private readonly ManualGrinderFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int ManualGrinderID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ManualGrinderID"), 0);
			}
			set
			{
				SetValue("ManualGrinderID", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string ManualGrinderPromotionTitle
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ManualGrinderPromotionTitle"), @"");
			}
			set
			{
				SetValue("ManualGrinderPromotionTitle", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string ManualGrinderPromotionDescription
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ManualGrinderPromotionDescription"), @"");
			}
			set
			{
				SetValue("ManualGrinderPromotionDescription", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string ManualGrinderBannerText
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ManualGrinderBannerText"), @"");
			}
			set
			{
				SetValue("ManualGrinderBannerText", value);
			}
		}


		/// <summary>
		/// Gets an object that provides extended API for working with ManualGrinder fields.
		/// </summary>
		[RegisterProperty]
		public ManualGrinderFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with ManualGrinder fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ManualGrinderFields : AbstractHierarchicalObject<ManualGrinderFields>
		{
			/// <summary>
			/// The content item of type ManualGrinder that is a target of the extended API.
			/// </summary>
			private readonly ManualGrinder mInstance;
			...
			public int ID
			{
				get
				{
					return mInstance.ManualGrinderID;
				}
				set
				{
					mInstance.ManualGrinderID = value;
				}
			}
			...
			public string PromotionTitle
			{
				get
				{
					return mInstance.ManualGrinderPromotionTitle;
				}
				set
				{
					mInstance.ManualGrinderPromotionTitle = value;
				}
			}
			...
			public string PromotionDescription
			{
				get
				{
					return mInstance.ManualGrinderPromotionDescription;
				}
				set
				{
					mInstance.ManualGrinderPromotionDescription = value;
				}
			}
			...
			public string BannerText
			{
				get
				{
					return mInstance.ManualGrinderBannerText;
				}
				set
				{
					mInstance.ManualGrinderBannerText = value;
				}
			}
		}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="ManualGrinder" /> that is a target of the extended API.
			/// </summary>
			private readonly ManualGrinder mInstance;
