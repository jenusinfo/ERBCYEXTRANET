...
#warning "You will need to configure the type info."
        ...
        /// <summary>
        /// Personal and joint account expected document entity role.
        /// </summary>
        [DatabaseField]
        public virtual Guid PersonalAndJointAccount_ExpectedDocument_EntityRole
        {
            get
            {
                return ValidationHelper.GetGuid(GetValue("PersonalAndJointAccount_ExpectedDocument_EntityRole"), Guid.Empty);
            }
            set
            {
                SetValue("PersonalAndJointAccount_ExpectedDocument_EntityRole", value, Guid.Empty);
            }
        }
        ...
        /// <summary>
        /// Personal and joint account expected document is active.
        /// </summary>
        [DatabaseField]
        public virtual bool PersonalAndJointAccount_ExpectedDocument_IsActive
        {
            get
            {
                return ValidationHelper.GetBoolean(GetValue("PersonalAndJointAccount_ExpectedDocument_IsActive"), true);
            }
            set
            {
                SetValue("PersonalAndJointAccount_ExpectedDocument_IsActive", value);
            }
        }
