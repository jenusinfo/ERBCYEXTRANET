...
namespace Eurobank.Infrastructure
{
    /// <summary>
    ...
    public class CacheDependencyKeyProvider
    {
        ...
        public static string GetDependencyCacheKeyForPageType(string siteName, string className)
        {
            ...
            {
                return string.Format(GENERIC_PAGES_KEY_FORMAT, siteName.ToLowerInvariant());
            }

            return string.Format(PAGES_KEY_FORMAT, siteName.ToLowerInvariant(), className.ToLowerInvariant());
        }
