...
[assembly: RegisterWidget(ArticlesWidgetViewComponent.IDENTIFIER, typeof(ArticlesWidgetViewComponent), "Latest articles", typeof(ArticlesWidgetProperties), Description = "Displays the latest articles from the Eurobank site.", IconClass = "icon-l-list-article")]
...
namespace Eurobank.Widgets
{
    ...
    public class ArticlesWidgetViewComponent : ViewComponent
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "Eurobank.HomePage.ArticlesWidget";
