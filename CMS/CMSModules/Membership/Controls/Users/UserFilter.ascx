...
<div class="form-horizontal form-filter">
    ...
    <asp:Panel ID="pnlAdvancedFilter" runat="server" DefaultButton="btnAdvancedSearch">
        ...
        <asp:PlaceHolder ID="plcUserType" runat="server">
            <div class="form-group">
                <div class="filter-form-label-cell">
                    <cms:LocalizedLabel ID="lblUserType" runat="server" CssClass="control-label" AssociatedControlID="ddlUserTypes"
                        ResourceString="Eurobank.User.UserType" DisplayColon="true" EnableViewState="False" />
                </div>
                <div class="filter-form-value-cell-wide">
                    <cms:CMSDropDownList runat="server" ID="ddlUserTypes" AutoPostBack="true" OnSelectedIndexChanged="ddlUserTypes_SelectedIndexChanged" />
                </div>
            </div>
        </asp:PlaceHolder>
         <asp:PlaceHolder ID="plcUserOrganisation" runat="server">
            <div class="form-group">
                <div class="filter-form-label-cell">
                    <cms:LocalizedLabel ID="lblUserOrganisation" runat="server" CssClass="control-label" AssociatedControlID="ddlUserOrganisations"
                        ResourceString="Eurobank.User.UserOrganisation" DisplayColon="true" EnableViewState="False" />
                </div>
                <div class="filter-form-value-cell-wide">
                    <cms:CMSDropDownList runat="server" ID="ddlUserOrganisations" />
                </div>
            </div>
        </asp:PlaceHolder>
        <!-- --------------------------------------------------------------------------------------------------- -->
