...
namespace Eurobank.Helpers.Generator
{
    ...
    internal class CampaignDataGenerator
    {
        ...
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING = "Eurobank.CafeSamplePromotion";


        /// <summary>
        /// Code name of the finished 'Cafe sample promotion' campaign.
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED = "Eurobank.CafeSamplePromotionTest";
        ...
        private const string COFFEE_SAMPLE_LIST_FORM_CODE_NAME = "EurobankCoffeeSampleList";
        ...
        public void Generate()
        {
            CampaignInfo.Provider.Get()
                .WhereStartsWith("CampaignName", "Eurobank.")
                .OnSite(mSite.SiteID)
                .ToList()
