...
namespace Eurobank.Helpers
{
    ...
    public class AdminRedirectStartupFilter : IStartupFilter
    {
        ...
        /// <summary>
        /// Redirects a request to "/admin" to the administration site specified in <c>EurobankAdminUrl</c> app setting.
        /// </summary>
        private class AdminRedirectRule : IRule
        {
            ...
            {
                adminUrl = configuration["EurobankAdminUrl"] ?? String.Empty;
            }
