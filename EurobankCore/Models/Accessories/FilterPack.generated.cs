...
[assembly: RegisterDocumentType(FilterPack.CLASS_NAME, typeof(FilterPack))]

namespace CMS.DocumentEngine.Types.Eurobank
{
	/// <summary>
	/// Represents a content item of type FilterPack.
	/// </summary>
	public partial class FilterPack : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Eurobank.FilterPack";


		/// <summary>
		/// The instance of the class that provides extended API for working with FilterPack fields.
		/// </summary>
		private readonly FilterPackFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int FilterPackID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("FilterPackID"), 0);
			}
			set
			{
				SetValue("FilterPackID", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public int FilterPackQuantity
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("FilterPackQuantity"), 0);
			}
			set
			{
				SetValue("FilterPackQuantity", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string FilterPromotionTitle
		{
			get
			{
				return ValidationHelper.GetString(GetValue("FilterPromotionTitle"), @"");
			}
			set
			{
				SetValue("FilterPromotionTitle", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string FilterPromotionDescription
		{
			get
			{
				return ValidationHelper.GetString(GetValue("FilterPromotionDescription"), @"");
			}
			set
			{
				SetValue("FilterPromotionDescription", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string FilterBannerText
		{
			get
			{
				return ValidationHelper.GetString(GetValue("FilterBannerText"), @"");
			}
			set
			{
				SetValue("FilterBannerText", value);
			}
		}


		/// <summary>
		/// Gets an object that provides extended API for working with FilterPack fields.
		/// </summary>
		[RegisterProperty]
		public FilterPackFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with FilterPack fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class FilterPackFields : AbstractHierarchicalObject<FilterPackFields>
		{
			/// <summary>
			/// The content item of type FilterPack that is a target of the extended API.
			/// </summary>
			private readonly FilterPack mInstance;
			...
			public int ID
			{
				get
				{
					return mInstance.FilterPackID;
				}
				set
				{
					mInstance.FilterPackID = value;
				}
			}
			...
			public int Quantity
			{
				get
				{
					return mInstance.FilterPackQuantity;
				}
				set
				{
					mInstance.FilterPackQuantity = value;
				}
			}
			...
			public string FilterPromotionTitle
			{
				get
				{
					return mInstance.FilterPromotionTitle;
				}
				set
				{
					mInstance.FilterPromotionTitle = value;
				}
			}
			...
			public string FilterPromotionDescription
			{
				get
				{
					return mInstance.FilterPromotionDescription;
				}
				set
				{
					mInstance.FilterPromotionDescription = value;
				}
			}
			...
			public string FilterBannerText
			{
				get
				{
					return mInstance.FilterBannerText;
				}
				set
				{
					mInstance.FilterBannerText = value;
				}
			}
		}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="FilterPack" /> that is a target of the extended API.
			/// </summary>
			private readonly FilterPack mInstance;
