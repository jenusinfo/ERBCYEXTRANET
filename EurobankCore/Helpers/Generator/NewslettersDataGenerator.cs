...
namespace Eurobank.Helpers.Generator
{
    ...
    internal class NewslettersDataGenerator
    {
        ...
        private const string NEWSLETTER_EUROBANK = "Newsletter";
        ...
        {
            SubscribeContactWithEmailToNewsletter("monica.king@localhost.local", NEWSLETTER_EUROBANK);
            SubscribeContactWithEmailToNewsletter("monica.king@localhost.local", NEWSLETTER_COFFEE101);
            SubscribeContactWithEmailToNewsletter("Dustin.Evans@localhost.local", NEWSLETTER_EUROBANK);
            ...
            SubscribeContactWithEmailToNewsletter("Harold.Larson@localhost.local", NEWSLETTER_EUROBANK);
        }
