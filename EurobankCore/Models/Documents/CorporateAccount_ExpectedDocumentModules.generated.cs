...
#warning "You will need to configure the type info."
        ...
        /// <summary>
        /// Corporate account expected document roles related to entity.
        /// </summary>
        [DatabaseField]
        public virtual Guid CorporateAccount_ExpectedDocument_RolesRelatedToEntity
        {
            get
            {
                return ValidationHelper.GetGuid(GetValue("CorporateAccount_ExpectedDocument_RolesRelatedToEntity"), Guid.Empty);
            }
            set
            {
                SetValue("CorporateAccount_ExpectedDocument_RolesRelatedToEntity", value, Guid.Empty);
            }
        }


        /// <summary>
        /// Corporate account expected document sub type.
        /// </summary>
        [DatabaseField]
        public virtual Guid CorporateAccount_ExpectedDocument_SubType
        {
            get
            {
                return ValidationHelper.GetGuid(GetValue("CorporateAccount_ExpectedDocument_SubType"), Guid.Empty);
            }
            set
            {
                SetValue("CorporateAccount_ExpectedDocument_SubType", value, Guid.Empty);
            }
        }
        ...
        /// <summary>
        /// Corporate account expected document type.
        /// </summary>
        [DatabaseField]
        public virtual Guid CorporateAccount_ExpectedDocument_Type
        {
            get
            {
                return ValidationHelper.GetGuid(GetValue("CorporateAccount_ExpectedDocument_Type"), Guid.Empty);
            }
            set
            {
                SetValue("CorporateAccount_ExpectedDocument_Type", value, Guid.Empty);
            }
        }
        ...
        /// <summary>
        /// Corporate account expected document is active.
        /// </summary>
        [DatabaseField]
        public virtual bool CorporateAccount_ExpectedDocument_IsActive
        {
            get
            {
                return ValidationHelper.GetBoolean(GetValue("CorporateAccount_ExpectedDocument_IsActive"), true);
            }
            set
            {
                SetValue("CorporateAccount_ExpectedDocument_IsActive", value);
            }
        }
