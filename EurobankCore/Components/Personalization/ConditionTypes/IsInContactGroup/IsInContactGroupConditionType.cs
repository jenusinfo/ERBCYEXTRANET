...
using Eurobank.Personalization;

using Kentico.Forms.Web.Mvc;
using Kentico.PageBuilder.Web.Mvc.Personalization;

[assembly: RegisterPersonalizationConditionType("Eurobank.Personalization.IsInContactGroup", typeof(IsInContactGroupConditionType), "Is in contact group", Description = "Evaluates if the current contact is in one of the contact groups.", IconClass = "icon-app-contact-groups", Hint = "Display to visitors who match at least one of the selected contact groups:")]
...
namespace Eurobank.Personalization
{
    ...
    public class IsInContactGroupConditionType : ConditionType
    {
        ...
        /// </summary>
        [EditingComponent("Eurobank.ContactGroupSelector", Order = 0, Label = "")]
