...
namespace Eurobank.Helpers.Generator
{
    public class TrackingConsentGenerator
    {
        private readonly ISiteInfo mSite;

        internal const string CONSENT_NAME = "EurobankTracking";
        private const string CONSENT_DISPLAY_NAME = "Eurobank - Tracking";
        private const string CONSENT_SHORT_TEXT_EN = @"At Eurobank, we have exciting offers and news about our products and services 
        ...
        private const string CONSENT_SHORT_TEXT_ES = @"En Eurobank, tenemos noticias y ofertas interesantes sobre nuestros productos y 
