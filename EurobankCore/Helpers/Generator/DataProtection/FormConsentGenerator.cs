...
namespace Eurobank.Helpers.Generator
{
    ...
    public class FormConsentGenerator
    {
        ...
        public const string CONSENT_NAME = "EurobankCoffeeSampleListForm";
        internal const string CONSENT_DISPLAY_NAME = "Eurobank - Coffee sample list form";
        ...
        /// <summary>
        /// Generates sample form consent data. Suitable only for Eurobank site.
        /// </summary>
